...
#define PHP_PARALLEL_WAKE   0x00000100
#define PHP_PARALLEL_CLOSE  0x00001000
#define PHP_PARALLEL_DONE   0x00010000
#define PHP_PARALLEL_CLOSED 0x00100000 
...
void php_parallel_monitor_unset(php_parallel_monitor_t *m, uint32_t state);
